---
name: prd-generator
description: Generates a structured PRD from a feature description or brief. Use when asked to write, draft, or create a PRD. Audience: Product managers (non-technical background).
---
...
**Note:** After generating the PRD, you can suggest using the `/user-story-writer` skill to break down the user stories section into detailed acceptance criteria.
...
- Use plain English — avoid technical jargon (remember: audience is non-technical PMs)
- Keep tone instructional and clear, as if explaining to a business stakeholder
...
- Ask the user if they want to save it to their project docs folder (e.g., `<project-name>/docs/prd.md`)
