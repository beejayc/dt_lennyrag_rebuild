...
description: Converts feature ideas or rough bullets into user stories with acceptance criteria. Use when asked to write user stories or break down a feature. Audience: Product managers and development teams.
---
...
**Tip:** If you're starting from a blank slate, use `/prd-generator` first to establish context, goals, and user research. Then use this skill to detail the user stories.
...
- A good story is something a developer can pick up and build in 1-5 days; if a story feels bigger, break it down
...
- After delivering the stories, ask: "Want me to add these to your project docs (e.g., `<project-name>/docs/user-stories.md`)?"
